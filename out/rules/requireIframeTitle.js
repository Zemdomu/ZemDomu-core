    ...
    return {
        ...
        enterJsx(path) {
            ...
            if (tag === 'iframe') {
                ...
                if (titleState === 'empty') {
                    const line = ((_f = (_e = opening.loc) === null || _e === void 0 ? void 0 : _e.start.line) !== null && _f !== void 0 ? _f : 1) - 1;
                    const column = (_h = (_g = opening.loc) === null || _g === void 0 ? void 0 : _g.start.column) !== null && _h !== void 0 ? _h : 0;
